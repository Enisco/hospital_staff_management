...
class RequestLeaveModel {
  ...
  factory RequestLeaveModel.fromJson(Map<String, dynamic> json) =>
      RequestLeaveModel(
        ...
        leaveStart: json["leave_start"] == null
            ? null
            : DateTime.parse(json["leave_start"]),
        leaveEnd: json["leave_end"] == null
            ? null
            : DateTime.parse(json["leave_end"]),
        created:
...
UpdateNotificationModel updateNotificationModelFromJson(String str) =>
    UpdateNotificationModel.fromJson(json.decode(str));

String updateNotificationModelToJson(UpdateNotificationModel data) =>
    json.encode(data.toJson());
...
class UpdateNotificationModel {
  ...
  factory UpdateNotificationModel.fromJson(Map<String, dynamic> json) =>
      UpdateNotificationModel(
        seen: json["seen"],
        created:
            json["created"] == null ? null : DateTime.parse(json["created"]),
